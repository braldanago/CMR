...
public class FabricaPistola extends Thread implements IFabrica {
	...
	public ArrayList<IProceso> hacerColaSRTF() {
		...
		fabricacion.setTiempoRestante(15);
		ensamble.setTiempoRestante(14);
		calidad.setTiempoRestante(13);;
		fabricacion1.setTiempoRestante(12);
		ensamble1.setTiempoRestante(11);
		calidad1.setTiempoRestante(10);
        ...
        while(true){
        	...
        	if(estaDisponible()) {
        		...
        		if(tiempoEjecucion>0) {
        			...
        			}else if(prioridad==2) {//////////*/*PRIORIDAD 2*///////////////
